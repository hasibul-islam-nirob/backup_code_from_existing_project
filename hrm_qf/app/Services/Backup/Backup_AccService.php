...
class Backup_AccService
{
    ...
    public static function fnCashBankBalance_new($balanceFor, $parameter = [])
    {
        ...
        $voucherType = (isset($parameter['voucherType'])) ? $parameter['voucherType'] : null;
        ...
        if (isset($opFetchFrom['voucherRA']) || isset($opFetchFrom['voucherLA'])) {
            ...
            $opVoucherMQuery = DB::table('acc_voucher')
                ...
                ->where(function ($opVoucherM) use ($voucherType){
                    if ($voucherType == 1) {
                        $opVoucherM->whereIn('voucher_type_id', [1,2,5]);
                    }
                })
                ->orderBy('voucher_date', 'ASC')
                ->get();
        ...
        if (isset($bpFetchFrom['voucherRA']) || isset($bpFetchFrom['voucherLA'])) {
            ...
            $bpVoucherM = DB::table('acc_voucher')
                ...
                ->where(function ($bpVoucherM) use ($voucherType){
                    if ($voucherType == 1) {
                        $bpVoucherM->whereIn('voucher_type_id', [1,2,5]);
                    }
                })
                ->orderBy('voucher_date', 'ASC')
                ->pluck('id')

...
class OSFController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $totalRecords = DB::table('hr_payroll_settings_osf')->select('count(*) as allcount')->where('is_delete', 0)->count();
            $totalRecordswithFilter = DB::table('hr_payroll_settings_osf')->select('count(*) as allcount')->where('is_delete', 0)->count();

            $allData  = OSF::where('is_delete', 0)
            ...
            foreach ($allData as $key => $row) {
                ...
                $countExistPfInSS= DB::table('hr_payroll_salary_structure')->where([['is_active', 1],['is_delete', 0],['osf_id', $row->id]])->count();
    ...
    public function insert(Request $request)
    {
        ...
        if ($passport['isValid']) {
            ...
            try {
                ...
                $id = DB::table('hr_payroll_settings_osf')->insertGetId([
    ...
    public function update(Request $request)
    {
        ...
        if ($passport['isValid']) {
            ...
            try {
                ...
                DB::table('hr_payroll_settings_osf')->where('id', $id)->update([
                    // 'group_id' => $request->group_id,
                    'company_id' => $request->company_id,
                    'project_id' => $request->project_id,
                    'rec_type_ids' => implode(',', $request->rec_type_id),
    ...
    {
        $delete = DB::table('hr_payroll_settings_osf')->where('id', decrypt($id))->update(['is_delete' => 1]);
    ...
    {
        $targetRow            = OSF::where('id', decrypt($id))->first();

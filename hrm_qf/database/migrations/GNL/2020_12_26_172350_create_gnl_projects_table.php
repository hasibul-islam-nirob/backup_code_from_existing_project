...
class CreateGnlProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gnl_projects', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            // $table->unique(['project_code','is_delete']);
    ...
    {
        Schema::dropIfExists('gnl_projects');
    }
}

...
class CreateGnlUnionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gnl_unions', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->integer('district_id')->nullable()->comment('Master id of districts table');
            $table->integer('upazila_id')->nullable()->index('Fk_upazilas_for_unions')->comment('Master id of upazilas table');
            $table->string('union_name',20)->nullable();
    ...
    {
        Schema::dropIfExists('gnl_unions');
    }
}

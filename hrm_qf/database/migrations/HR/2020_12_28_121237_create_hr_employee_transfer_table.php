...
class CreateHrEmployeeTransferTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hr_employee_transfer', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->integer('branch_from')->comment('Master id of Branch Table');
    ...
    {
        Schema::dropIfExists('hr_employee_transfer');
    }
}

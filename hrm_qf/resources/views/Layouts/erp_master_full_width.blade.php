...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/datatables.net-fixedheader-bs4/dataTables.fixedheader.bootstrap4.min.css') }}">
    <script src="{{ asset('assets/vendor/datatables.net-fixedheader/dataTables.fixedHeader.min.js') }}"></script>
...
<body class="animsition site-navbar-small dashboard">
    ...
    <div class="w-full forLoader minHeight">
    ...
    {{-- btn-lg --}}
    <a id="back-to-top" href="javascript:void(0);" class="btn btn-primary back-to-top d-print-none" role="button">
        <i class="fas fa-chevron-up"></i>
    </a>

    <a id="back-to-down" href="javascript:void(0);" class="btn btn-primary back-to-down d-print-none" role="button">
    ...
    <script type="text/javascript">
        ...
        let console_error = "{{Session::get('console_error')}}";
        ...
        $(document).ready(function () {
            var softStartDate =
                "{{ (new Datetime(App\Services\CommonService::getBranchSoftwareStartDate()))->format('Y-m-d') }}";
            $('.datepicker-custom:not(#customer_dob,#gr_dob,#emp_dob), .datepicker:not(#customer_dob,#gr_dob,#emp_dob), .monthPicker')
            .datepicker("option", "minDate", new Date(softStartDate));
        });
    ...
    <script src="{{ asset('assets/js/Plugin/raty.js') }}"></script>
    <!-- <script src="{{ asset('assets/js/uikit/panel-structure.js') }}"></script> -->
    ...
    <!-- <script src="{{asset('assets/js/Plugin/bootstrap-datepicker.min.js')}}"></script> -->
    <script src="{{asset('assets/js/Plugin/asscrollable.min.js')}}"></script>

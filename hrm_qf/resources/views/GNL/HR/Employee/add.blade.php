                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <div class="help-block with-errors is-invalid" id="txtOrgMobError"></div>
                        </div>

                        <div class="col-lg-4 form-group">
                            <label class="input-title RequiredStar">Username</label>
                            <div class="input-group">
                        ...
                        <div class="col-lg-4 form-group">
                            <label class="input-title RequiredStar">Password</label>
                            <div class="input-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" pattern="[01][0-9]{10}" class="form-control round textNumber" name="mobile_no"
                                    ...
                                    onblur="fnCheckDuplicate(
                                        ...
                                        'txtMobileError', 
                                        'mobile number');">
                            <div class="help-block with-errors is-invalid" id="txtMobileError"></div>
                        </div>
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control round textNumber identificationInput" name="passport_no"
                                    id="passport_no" maxlength="9" placeholder="Enter Passport No">
                            </div>
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control round textNumber identificationInput" name="driving_license_no"
                                    id="driving_license_no" maxlength="15" placeholder="Enter Driving License No">
                            </div>
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control round textNumber identificationInput" name="birth_certificate_no"
                                    id="birth_certificate_no" maxlength="17" placeholder="Enter Birth Certificate No">
                            </div>

...
@section('content')
    ...
    @include('elements.common_filter_options', [
        ...
        [
            ...
            'field_id' => 'pro_start_date',
            'field_name' => 'pro_start_date',
            'field_value' => null
        ],
        [
            'field_text' => 'End Date',
            'field_id' => 'pro_end_date',
            'field_name' => 'pro_end_date',
            'field_value' => null
        ]
        ],
        'department' => true,
        'designation' => true,
        'textField' => [
            'field_text' => 'Promotion Code',
            'field_id' => 'se_promotion_code',
            'field_name' => 'se_promotion_code',
            'field_value' => null
        ],
        ...
        function ajaxDataLoad() {
            ...
            $('.clsDataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "type": "post",
                    "data": {
                        "start_date": $('#pro_start_date').val(),
                        "end_date": $('#pro_end_date').val(),
                        "zone_id": $('#zone_id').val(),
                        ...
                        "appl_code": $('#se_promotion_code').val(),

    ...
    <form enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
        ...
        <div class="row">
            <div class="col-lg-9 offset-lg-3">
                ...
                <!-- Html View Load  -->
                {!! HTML::forCompanyFeild($DesignationData->company_id,'disabled') !!}
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            <input type="text" class="form-control round" name="name"
                             ...
                             value="{{$DesignationData->name}}" readonly>
                        </div>
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            ...
                            placeholder="Enter Name" value="{{$DesignationData->short_name}}" readonly>
                        </div>
                    </div>
                </div>

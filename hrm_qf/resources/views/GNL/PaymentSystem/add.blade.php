    ...
    <div class="row">
        <div class="col-lg-9 offset-lg-3">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="payment_system_name" id="payment_system_name" class="form-control round"
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="short_name" id="short_name" class="form-control round"
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="order_by" id="order_by" class="form-control round"

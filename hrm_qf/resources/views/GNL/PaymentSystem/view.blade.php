    ...
    <div class="row">
        <div class="col-lg-9 offset-lg-3">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group"> 
                        <input type="text" name="payment_system_name" id="payment_system_name" readonly class="form-control round" value="{{$TargetData->payment_system_name}}" 
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="short_name" id="short_name" class="form-control round" readonly value="{{$TargetData->short_name}}" 
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="order_by" id="order_by" class="form-control round" readonly value="{{$TargetData->order_by}}" 
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5 input-group">
                    <select class="form-control clsSelect2" name="status" id="status" disabled
                        required style="width: 100%;">

                        <option value="0"  {{($TargetData->status==0)? 'selected':''}}>For Payment/supplier</option>
                        <option value="1"  {{($TargetData->status==1)? 'selected':''}} >For Collection/sales </option>
                        <option value="2"  {{($TargetData->status==2)? 'selected':''}}>For All</option>

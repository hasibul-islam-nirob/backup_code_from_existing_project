        ...
        <div class="row">
            <div class="col-lg-9 offset-lg-3">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            <input type="text" class="form-control round" name="district_name" id="district_name" placeholder="Enter District Name" required data-error="Please enter District name.">
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>

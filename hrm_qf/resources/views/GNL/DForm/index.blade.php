...
@php
    $moduleList = DB::table('gnl_sys_modules')->where('is_delete', 0)->select('id', 'module_name', 'module_short_name')->orderBy('module_name', 'ASC')->get();
...
<div class="row align-items-center d-flex justify-content-center pb-5">
    ...
    <div class="col-lg-3">
        ...
        <div class="input-group">
            <select class="form-control clsSelect2" name="typeId" id="typeId">
                <option value="">Select All</option>
...
<script>
    ...
    function ajaxDataLoad(){
        $('.clsDataTable').DataTable({
            ...
            "columns": [
                ...
                { data: "input_type", className: 'text-center', orderable: false},
    ...
    function fnDelete(RowID) {
        ...
        */
        ...
        fnDeleteCheck(
            "{{url('gnl/dynamic_form/delete/')}}",
            "{{url('/ajaxDeleteCheck')}}",
            RowID
            // "{{base64_encode('form_id')}}",
            // "{{base64_encode('is_delete,0')}}",
            // "{{base64_encode('gnl_dynamic_form_value')}}"
        );
    }

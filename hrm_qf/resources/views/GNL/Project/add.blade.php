    ...
    <form enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
        ...
        <div class="row">
            <div class="col-lg-9 offset-lg-3">
                ...
                <!--for Ajax Post-->
                <!-- <input type="hidden" id="ajaxload" name="_token" value="{{csrf_token()}}"> -->
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group ">
                            <select class="form-control clsSelect2" name="group_id" id="group_id"
                                data-dependent="company_id" required data-error="Please select group name."
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="company_id" id="company_id"
                                required data-error="Please select Company name." onchange="fnAjaxSelectBox(
                                                'project_id',
                                                this.value,
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            <input type="text" class="form-control round" placeholder="Enter village Name"
                                ...
                                data-error="Please enter Project name.">
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5 form-group">
                        <div class="input-group">
                            <input type="text" name="project_code" id="checkDuplicateCode"
                                class="form-control round" placeholder="Enter Project Code" required

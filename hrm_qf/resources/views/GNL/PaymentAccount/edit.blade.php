    ...
    <div class="row">
        <div class="col-lg-9 offset-lg-3">
                ...
                <div class="col-lg-5 input-group">
                    <select class="form-control clsSelect2" name="payment_system_id" id="payment_system_id"
                       ...
                       @foreach($PaySystemList as $PData)
                        <option value="{{ $PData->id }}" {{($PData->id == $TargetData->payment_system_id)? 'selected':''}}>{{ $PData->payment_system_name }}</option>
                        @endforeach
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div>
                            {!! HTML::forLedgerSelectFeild($TargetData->ledger_id, "ledger_id","ledger_id") !!}
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <select class="form-control clsSelect2" name="status" id="status" required style="width: 100%;">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" pattern="[01][0-9]{10}" class="form-control round textNumber"
                            name="mobile" id="mobile" placeholder="Mobile Number (01*********) (optional)" value="{{$TargetData->mobile}}"
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="email" class="form-control round" id="email" name="email"  value="{{$TargetData->email}}"
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" name="routing_no" id="routing_no" value="{{$TargetData->routing_no}}" class="form-control round"

...
<?php
  ...
  $upazilaData = Common::ViewTableOrder('gnl_upazilas',
      ...
      ['id', 'upazila_name'],
      ['upazila_name', 'ASC']);
  $unionData = Common::ViewTableOrder('gnl_unions',
      [['is_delete', 0], ['is_active', 1]],
      ['id', 'union_name'],
      ['union_name', 'ASC']);
?>
  ...
  <div class="row align-items-center pb-10 d-print-none">
      ...
      <div class="col-lg-2">
          ...
          <div class="input-group">
              ...
              onchange="fnAjaxSelectBox('union_id',this.value,
...
<!-- End Page -->
<script>
function ajaxDataLoad(divisionID = null, districtID = null, upazilaID = null, unionID = null){
    ...
    $('.clsDataTable').DataTable({
        ...
        columns: [
              ...
              { data: 'union_name', name: 'union_name', orderable: false },
...
$(document).ready( function () {
    ...
    $('#searchButton').click(function() {
        ...
        ajaxDataLoad(divisionID, districtID, upazilaID, unionID);
    });
  });
        ...
        function fnDelete(RowID) {
            ...
            fnDeleteCheck(
                "{{url('gnl/village/delete/')}}",
                "{{url('/ajaxDeleteCheck')}}",
                RowID,
                "{{base64_encode('village_id')}}",
                ""
            );
        }

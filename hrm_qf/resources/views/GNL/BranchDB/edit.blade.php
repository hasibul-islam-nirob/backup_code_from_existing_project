            ...
            <div class="col-lg-9 offset-lg-3">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-5 form-group">
                        ...
                        <input type="text" class="form-control round" name="table_name" placeholder="Enter Table Name" value="{{$Branchtable->table_name}}" required data-error="Please enter Table name.">
                        </div>

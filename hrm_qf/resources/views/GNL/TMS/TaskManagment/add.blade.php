...
<form id="new_task_add_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true" style="padding: 0px 0.6rem 0px 0.6rem">
    @csrf
    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title">Assigned To</label>
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 form-group">
                    ...
                    <textarea class="form-control" id="instruction" name="instruction" rows="1">

                    </textarea>
                </div>

                {{-- Insert To status column default value zero --}}
...
<script>
    ...
    $('#assigned_by').change(function () {
        if($('#assigned_by').val() == $('#assigned_to').val()){
            swal({
                icon: 'error',
                title: 'Oops...',
    ...
    $('#add_saveBtn').click(function(event) {
        ...
        let formData = new FormData($('#new_task_add_form')[0]);
    ...
    function fnGenTaskCode(ModuleId, TaskType) {
        ...
        if (ModuleId != '') {
            ...
            $.ajax({
                ...
                data: {
                    context: 'genaretTaskCodeForTask',
    ...
    $(document).ready(function(){
        $('#task_type_id').change(function() {
            ...
            fnGenTaskCode(module_id, task_type);
        });

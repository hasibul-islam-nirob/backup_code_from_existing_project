...
<script>
    ...
    async function showTaskData(response){
        ...
        var assigned_to = (response.result_data.assigned_to) != null ? response.employeeInfo[response.result_data.assigned_to] : "-";
        ...
        html += '<tr>' +
            ...
            '<td style="width: 3%"></td>' +
            '<td style="width: 20%"><b>Assigned To</b></td>' +
            '<td style="width: 30%">'+ assigned_to +'</td>' +
        '</tr>';
        ...
        html += '<tr><td colspan="5" style="width: 100%">&nbsp;</tr>';
        html += '<tr><td colspan="5" style="width: 100%"><b>Instruction</b></td></tr>';

        html += '<tr><td style="width: 100%" colspan="5">' + 
                '<textarea class="form-control ckeditor" id="instruction" readonly>' + response.result_data.instruction + '</textarea>' +
                '</td></tr>';

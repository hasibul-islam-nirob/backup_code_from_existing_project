        ...
        <div class="col-lg-8 offset-lg-3">
            ...
            <div style="display:none;" id="periodDiv">
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control round" name="start_time" id="start_time">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input  type="text" class="form-control round" id="end_time" name="end_time">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        ...
                        placeholder="Enter Notice" required data-error="Please Enter Notice"></textarea> 
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-9 form-group">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="input-group checkbox-custom checkbox-primary">
                                    <input type="checkbox" name="branchId[]" id="branch_0" value="0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group checkbox-custom checkbox-primary">
                                    <input type="checkbox" class="branch_cls" name="branchId[]" id="branch_{{ $branch->id }}" value="{{ $branch->id }}">

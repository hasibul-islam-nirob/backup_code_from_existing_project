...
<form id="contract_conclude_edit_form" enctype="multipart/form-data" method="post" data-toggle="validator"
    novalidate="true">
    @csrf

    <input hidden id="contract_conclude_id" name="contract_conclude_id">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="edit_contract_conclude_date" name="contract_conclude_date" type="text"
...
<script>
    callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
        ...
        function(response, textStatus, xhr) {
            ...
            $('#edit_contract_conclude_date').val(response.result_data.contract_conclude_date);
            ...
            showModal({
                titleContent: "Edit Contract Conclude Application",

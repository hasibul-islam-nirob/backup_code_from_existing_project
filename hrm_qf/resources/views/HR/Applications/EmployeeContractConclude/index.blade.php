...
@section('content')
    ...
    {{-- @include('elements.common_filter_options', [
        ...
        [
            ...
            'field_id' => 'ccl_start_date',
            'field_name' => 'ccl_start_date',
            'field_value' => null
        ],
        [
            'field_text' => 'End Date',
            'field_id' => 'ccl_end_date',
            'field_name' => 'ccl_end_date',
            'field_value' => null
        ]
        ],
        'employee' =>true,
        ...
        'designation' => true,
        'textField' => [
            'field_text' => 'Contract Conclude Code',
            'field_id' => 'se_contract_conclude_code',
            'field_name' => 'se_contract_conclude_code',
            'field_value' => null
        ],
    ...
    @php
        ...
        $elementArray['select_box2'] = [
            'label'=>"Contract Conclude Code",
            'type'=>'text',
            'id'=> 'se_contract_conclude_code',
            'name' => 'se_contract_conclude_code',
        ];
            ...
            $('.clsDataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        "appl_code": $('#se_contract_conclude_code').val(),

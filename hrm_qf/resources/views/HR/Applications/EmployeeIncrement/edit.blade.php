...
<form id="increment_edit_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf

    <input hidden id="increment_id" name="increment_id">
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_current_salary" style="z-index:99999 !important;" name="current_salary" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_requested_salary" style="z-index:99999 !important;" name="requested_salary" type="text" class="form-control" placeholder="">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="edit_increment_date" name="increment_date" type="text"
...
<script>
    ...
    callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
        ...
        function(response, textStatus, xhr) {
            ...
            $('#edit_increment_date').val(response.result_data.increment_date);
            ...
            $('#increment_id').val("{{ $id }}");
             ...
             $('#edit_current_salary').val(response.result_data.current_salary);
             $('#edit_requested_salary').val(response.result_data.requested_salary);
            ...
            showModal({
                titleContent: "Edit Increment Application",
    ...
    function configureActionEvents() {
        $('#edit_sendBtn').click(function(e) {
            ...
            let formData = new FormData($('#increment_edit_form')[0]);
    ...
    $("#edit_exp_effective_date").on('change', function() {
        let appDate = $("#edit_increment_date").val();

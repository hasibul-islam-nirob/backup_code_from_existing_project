...
@section('content')
    ...
    {{-- @include('elements.common_filter_options', [
        ...
        [
            ...
            'field_id' => 'dis_start_date',
            'field_name' => 'dis_start_date',
            'field_value' => null
        ],
        [
            'field_text' => 'End Date',
            'field_id' => 'dis_end_date',
            'field_name' => 'dis_end_date',
            'field_value' => null
        ]
        ],
        'employee' =>true,
        ...
        'designation' => true,
        'textField' => [
            'field_text' => 'Dismiss Code',
            'field_id' => 'se_dismiss_code',
            'field_name' => 'se_dismiss_code',
            'field_value' => null
        ],

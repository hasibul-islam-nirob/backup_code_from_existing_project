...
<form id="dismiss_add_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="add_dismiss_date" name="dismiss_date" type="text" style="z-index:99999 !important;"
...
<script>
    ...
    showModal({
        titleContent: "Add Dismiss Application",
    ...
    $('#add_sendBtn').click(function(event) {
        ...
        let formData = new FormData($('#dismiss_add_form')[0]);

...
<form id="dismiss_edit_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf

    <input hidden id="dismiss_id" name="dismiss_id">
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    <label class="input-title RequiredStar">Dismiss Date</label>
                    <div class="input-group">
                        ...
                        <input id="edit_dismiss_date" name="dismiss_date" type="text" style="z-index:99999 !important;"
...
<script>
    ...
    callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
        ...
        function(response, textStatus, xhr) {
            ...
            $('#edit_dismiss_date').val(response.result_data.dismiss_date);
            ...
            showModal({
                titleContent: "Edit Dismiss Application",
    ...
    function configureActionEvents() {
        ...
        $('#edit_sendBtn').click(function(e) {
            ...
            let formData = new FormData($('#dismiss_edit_form')[0]);

        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_advanced_amount" name="advanced_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_installment_amount"  name="installment_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_no_of_installment" name="no_of_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_first_repay_month"  name="first_repay_month" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
    ...
    $(document).ready(function(){
        ...
        callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
            ...
            function(response, textStatus, xhr) {
                ...
                showModal({
                    titleContent: "Edit Advance Salary Application",
                    footerContent: getModalFooterElement({
                        'btnNature': {
                            0: 'send',
                            1: 'save',

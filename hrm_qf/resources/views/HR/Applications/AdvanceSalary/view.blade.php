...
<form id="advance_salary_edit_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                <input hidden id="advance_salary_id" name="advance_salary_id">
                ...
                <div id="employee_edit_div" class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <select id="edit_project_id" name="project_id" class="form-control clsSelect2" style="width: 100%" disabled>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title ">Advanced Amount</label>
                    <div class="input-group">
                        <input id="edit_advanced_amount" name="advanced_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="" disabled>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_installment_amount"  name="installment_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="" disabled>
                    </div>
                </div>


                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title ">No of installment</label>
                    <div class="input-group">
                        <input id="edit_no_of_installment" name="no_of_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="" disabled>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    <label class="input-title ">First Repay Month: <small>(month, year)</small> </label>
                    <div class="input-group">
                        <input id="edit_first_repay_month"  name="first_repay_month" style="z-index:99999 !important;" type="text" class="form-control" placeholder="" disabled>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
            ...
            function(response, textStatus, xhr) {
                ...
                $('#edit_advanced_amount').val(response.result_data.advanced_amount);
                $('#edit_installment_amount').val(response.result_data.installment_amount);
                $('#edit_no_of_installment').val(response.result_data.no_of_installment);
                $('#edit_first_repay_month').val(response.result_data.first_repay_month);
                ...
                showModal({
                    titleContent: "View Advance Salary Application",
    ...
    //         let formData = new FormData($('#advance_salary_edit_form')[0]);

    ...
    <div class="row">
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div id="project_add_div" class="col-sm-5 offset-sm-2 form-group">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="add_collection_amount" name="collection_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5  form-group">
                    ...
                    <div class="input-group">
                        <input id="add_collection_month"  name="collection_month" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <select name="collection_type" id="add_collection_type" class="form-control clsSelect2" style="width: 100%">
                ...
                <div id="collection_by_add_div" class="col-sm-5 form-group">
                    <label class="input-title RequiredStar">Collection By</label>
                    <div class="input-group">
                        <select id="add_collection_by_employee_id" name="collection_by" class="form-control clsSelect2" style="width: 100%">
                            <option value="">Select employee</option>
                        </select>
                    </div>
                </div>
                ...
                {{-- <div class="col-sm-5  form-group">
                    <label class="input-title RequiredStar">Collection By</label>
                    <div class="input-group">
                        <select name="collection_by" id="add_collection_by" class="form-control clsSelect2" style="width: 100%">
                            <option value="" selected disabled>Select One</option>
                            <option value="advanced">Advanced</option>
                            <option value="others">Others</option>
                        </select>
...
<script>
    ...
    $('#add_branch_id').change(function(event) {
        callApi("{{ route('getEmployeesOptionsByBranch', '') }}/" + ($(this).val() === '' ? '-1' : $(this)
            ...
            function(response, textStatus, xhr) {
                ...
                $('#add_employee_id, #add_collection_by_employee_id').select2({
                    dropdownParent: $("#commonModal"),
                    data: response,
                ...
                if (appFor == "others") {
                    ...
                    $('#add_collection_by_employee_id').val('').trigger('change');
                } else {
                    $('#add_employee_id').val({{ $loginUserInfo->emp_id }}).trigger('change');
                    $('#add_collection_by_employee_id').val({{ $loginUserInfo->emp_id }}).trigger('change');
                }
    ...
    function configureSelfApplicationForm() {
        ...
        showModal({
            titleContent: "Add Security Money Application",

...
@section('content')
    ...
    @php
        ...
        $elementArray['select_box2'] = [
            'label'=>"Vehicle Loan Code",
            'type'=>'text',
            'id'=> 'se_vehicle_loan_code',
            'name' => 'se_vehicle_loan_code',
        ];
            ...
            $('.clsDataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        "appl_code": $('#se_vehicle_loan_code').val(),

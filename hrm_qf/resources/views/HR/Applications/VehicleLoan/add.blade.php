...
<form id="vehicle_loan_add_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <select id="add_vehicle_type" name="vehicle_type" class="form-control clsSelect2" style="width: 100%">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="add_requested_loan_amount" name="requested_loan_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="add_installment_amount" name="requested_no_of_loan_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
...
<script>
    ...
    $('#add_sendBtn').click(function(event) {
        ...
        let formData = new FormData($('#vehicle_loan_add_form')[0]);
    ...
    function configureSelfApplicationForm() {
        ...
        showModal({
            titleContent: "Add Vehicle Loan Application",

        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    <label class="input-title RequiredStar">Vehicle Type</label>
                    <div class="input-group">
                        <select id="edit_vehicle_type" name="vehicle_type" class="form-control clsSelect2" style="width: 100%">
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_requested_loan_amount" name="requested_loan_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_installment_amount" name="requested_no_of_loan_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
            ...
            function(response, textStatus, xhr) {
                ...
                showModal({
                    titleContent: "Edit Vehicle Loan Application",
    ...
    function configureActionEvents() {
        ...
        $('#edit_sendBtn').click(function(e) {
            ...
            let formData = new FormData($('#vehicle_loan_edit_form')[0]);

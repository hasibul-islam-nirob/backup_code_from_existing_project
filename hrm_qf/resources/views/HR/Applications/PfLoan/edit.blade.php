        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group offset-sm-2">
                    ...
                    <div class="input-group">
                        <input id="edit_employment_age" name="employment_age" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_org_contribution_amount"  name="org_contribution_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_emp_pf_amount" name="emp_pf_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_eligible_amount"  name="eligible_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_interest_amount" name="interest_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5  form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_requested_loan_amount"  name="requested_loan_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-sm-5 offset-sm-2 form-group">
                    ...
                    <div class="input-group">
                        <input id="edit_requested_no_of_loan_installment" name="requested_no_of_loan_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
            ...
            function(response, textStatus, xhr) {
                ...
                showModal({
                    titleContent: "Edit PF Loan Application",
    ...
    function configureActionEvents() {
        ...
        $('#edit_sendBtn').click(function(e) {
            ...
            let formData = new FormData($('#pf_loan_edit_form')[0]);

...
<form id="pf_loan_edit_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-sm-10 offset-sm-1">
            ...
            <div class="row">
                ...
                <input hidden id="loan_id" name="loan_id">
                ...
                <div class="col-sm-5 form-group">
                    <label class="input-title ">Org. Contribution Amount</label>
                    <div class="input-group">
                        <input id="edit_org_contribution_amount"  name="org_contribution_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="" disabled>
                    </div>
                </div>
            
                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title ">Employee PF Amount</label>
                    <div class="input-group">
                        <input id="edit_emp_pf_amount" name="emp_pf_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="" disabled>
                    </div>
                </div>

                <div class="col-sm-5 form-group">
                    <label class="input-title ">Eligible Amount</label>
                    <div class="input-group">
                        <input id="edit_eligible_amount"  name="eligible_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="" disabled>
                    </div>
                </div>
            
                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title ">Interest Amount</label>
                    <div class="input-group">
                        <input id="edit_interest_amount" name="interest_amount" type="text" style="z-index:99999 !important;" class="form-control" placeholder="" disabled>
                    </div>
                </div>

                <div class="col-sm-5  form-group">
                    <label class="input-title ">Requested Loan Amount</small> </label>
                    <div class="input-group">
                        <input id="edit_requested_loan_amount"  name="requested_loan_amount" style="z-index:99999 !important;" type="text" class="form-control" placeholder="" disabled>
                    </div>
                </div>
            
                <div class="col-sm-5 offset-sm-2 form-group">
                    <label class="input-title ">Requested No of Loan Installment</label>
                    <div class="input-group">
                        <input id="edit_requested_no_of_loan_installment" name="requested_no_of_loan_installment" type="text" style="z-index:99999 !important;" class="form-control" placeholder="" disabled>
                    </div>
                </div>
    ...
    $(document).ready(function(){
        ...
        callApi("{{ url()->current() }}/../../get/" + "{{ $id }}/api", 'post', '',
            ...
            function(response, textStatus, xhr) {
                ...
                $('#edit_org_contribution_amount').val(response.result_data.org_contribution_amount);
                $('#edit_emp_pf_amount').val(response.result_data.emp_pf_amount);
                $('#edit_eligible_amount').val(response.result_data.eligible_amount);
                $('#edit_interest_amount').val(response.result_data.interest_amount);
                $('#edit_requested_loan_amount').val(response.result_data.requested_loan_amount);
                $('#edit_requested_no_of_loan_installment').val(response.result_data.requested_no_of_loan_installment);
                ...
                showModal({
                    titleContent: "View PF Loan Application",
                });

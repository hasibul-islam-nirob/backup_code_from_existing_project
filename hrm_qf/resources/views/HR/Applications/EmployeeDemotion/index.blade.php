...
@section('content')
    ...
    {{-- @include('elements.common_filter_options', [
        ...
        [
            ...
            'field_id' => 'dem_start_date',
            'field_name' => 'dem_start_date',
            'field_value' => null
        ],
        [
            'field_text' => 'End Date',
            'field_id' => 'dem_end_date',
            'field_name' => 'dem_end_date',
            'field_value' => null
        ]
        ],
        'employee' =>true,
        ...
        'designation' => true,
        'textField' => [
            'field_text' => 'Demotion Code',
            'field_id' => 'se_demotion_code',
            'field_name' => 'se_demotion_code',
            'field_value' => null
        ],
            ...
            $('.clsDataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        "appl_code": $('#se_demotion_code').val(),

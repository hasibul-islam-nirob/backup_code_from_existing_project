...
<div id="draftView" style="display: none;">
    @include('HR.CommonBlade.detailsGrid',['title' => 'Retirement Application Details'])
</div>
...
<script>
        ...
        function(response, textStatus, xhr) {
            ...
            if(response.result_data['is_active'] == 0 || response.result_data['is_active'] == 1){//Draft view
                ...
                showApplicantData(response.result_data).then(()=>{
                    ...
                    showModal({
                        titleContent: "View Retirement Application",
                    });
    ...
    async function showApplicantData(response){
        ...
        html += '<tr>' +
            '<td style="width: 20%"><b>Retirement Code</b></td>' +
            '<td style="width: 27%">'+ response.retirement_code +'</td>' +
        ...
        html += '<tr>' +
            ...
            '<td style="width: 20%"><b>Retirement Date</b></td>' +
            '<td style="width: 30%">'+ response.retirement_date +'</td>' +
        '</tr>';

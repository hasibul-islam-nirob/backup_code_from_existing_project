...
<form id="retirement_add_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="add_retirement_date" name="retirement_date" type="text"
...
<script>
    ...
    $('#add_sendBtn').click(function(event) {
        ...
        let formData = new FormData($('#retirement_add_form')[0]);
    ...
    $("#add_exp_effective_date").on('change', function() {
        let appDate = $("#add_retirement_date").val();

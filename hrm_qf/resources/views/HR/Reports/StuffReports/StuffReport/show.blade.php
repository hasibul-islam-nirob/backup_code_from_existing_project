...
@section('content')
    ...
    <script>
        $(document).ready(function(event){
            ...
            $('#searchButton').click(function(){
                ...
                $('#filterFormId').submit(function (event) {
                    ...
                    if(flag){
                        $('.show').show('slow');
                        $("#reportingDiv").load('{{URL::to("hr/reports/stf_report/loadData")}}'+'?'+$("#filterFormId").serialize());
                    }
                });
            })
        });
        ...
        //         $("#report_body").load('{{URL::to("hr/reports/stf_report/loadData")}}'+'?'+$("#employee_search_form").serialize());
        //     });
        // });

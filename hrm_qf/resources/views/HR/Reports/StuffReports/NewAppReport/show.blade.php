        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'New Appointment  Report Stuff',
                    'title_excel' => 'New_Appointment_Report_Stuff',
        ...
        $(document).ready(function(event){
            $('#searchButton').click(function(){
                ...
                $('#filterFormId').submit(function (event) {
                    ...
                    if(flag){
                        $('.show').show('slow');
                        $("#reportingDiv").load('{{URL::to("hr/reports/new_app_report/loadData")}}'+'?'+$("#filterFormId").serialize());
                    }
                });
            })
        });

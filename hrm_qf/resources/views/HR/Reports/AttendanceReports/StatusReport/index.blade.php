...
@section('content')
    ...
    @php
        ...
        // $elementArray['monthYear'] = ['label' => 'Start Date','type' =>'monthYear','id' => '','name' => '','value' => '', 'required' => true];
        // $elementArray['monthYear'] = ['label' => 'End Date','type' =>'monthYear','id' => '','name' => '','value' => '', 'required' => true];

        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Promotion Report',
                    'title_excel' => 'Employee_Promotion_Report',
    ...
    $(document).ready(function(event){
        $('#searchButton').click(function(){
            $('#filterFormId').submit(function (event) {
                ...
                if(flag){
                    $('.show').show('slow');
                    $("#reportingDiv").load('{{URL::to("hr/reports/emp_promotion/loadData")}}'+'?'+$("#filterFormId").serialize());
                }
            });
        })
    });

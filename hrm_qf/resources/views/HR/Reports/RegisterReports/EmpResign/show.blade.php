        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Resign Report',
                    'title_excel' => 'Employee_Resign_Report',
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#searchButton').click(function () {
                ...
                if(flagMessage == false){
                    ...
                    if ($("#filterFormTrial").length) {
                        fnLoading(true);
                    }

                    $("#filterFormTrial").submit();
                }
                else{
                    swal({
                        icon: 'warning',
        ...
        $('#searchButton').click(function(){
            ...
            $('#filterFormId').submit(function (event) {
                ...
                if(flag){
                    $('.show').show('slow');
                    $("#reportingDiv").load('{{URL::to("hr/reports/emp_resign/loadData")}}'+'?'+$("#filterFormId").serialize());
                }
            });
        })

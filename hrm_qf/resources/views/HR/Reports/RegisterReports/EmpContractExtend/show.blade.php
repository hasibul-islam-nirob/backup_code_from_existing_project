...
@section('content')
    ...
    @php
        ...
        $elementArray['select_box2'] = [
            'label'=>"Contract Extend Code",
            'type'=>'text',
            'id'=> 'se_contract_ext_code',
            'name' => 'se_contract_ext_code',
        ];
        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Contract Extend Report',
                    'title_excel' => 'Employee_Contract_Extend_Report',
    ...
    <script>
        ...
        $(document).ready(function(event){
            $('#searchButton').click(function(){
                ...
                $('#filterFormId').submit(function (event) {
                    ...
                    if(flag){
                        $('.show').show('slow');
                        $("#reportingDiv").load('{{URL::to("hr/reports/emp_cont_ext/loadData")}}'+'?'+$("#filterFormId").serialize());
                    }
                });
            })
        });
        ...
        //         $('.show').show('slow');
        //         $("#report_body").load('{{URL::to("hr/reports/emp_cont_ext/loadData")}}'+'?'+$("#employee_search_form").serialize());

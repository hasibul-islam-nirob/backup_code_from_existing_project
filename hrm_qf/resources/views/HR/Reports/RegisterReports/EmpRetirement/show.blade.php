...
@section('content')
    ...
    @php
        ...
        $elementArray['select_box2'] = [
            'label'=>"Retirement Code",
            'type'=>'text',
            'id'=> 'se_retirement_code',
            'name' => 'se_retirement_code',
        ];
        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Retirement Report',
                    'title_excel' => 'Employee_Retirement_Report',
        ...
        $(document).ready(function(event){
            $('#searchButton').click(function(){
                ...
                $('#filterFormId').submit(function (event) {
                    ...
                    if(flag){
                        $('.show').show('slow');
                        $("#reportingDiv").load('{{URL::to("hr/reports/emp_retirement/loadData")}}'+'?'+$("#filterFormId").serialize());
                    }
                });
            })
        });

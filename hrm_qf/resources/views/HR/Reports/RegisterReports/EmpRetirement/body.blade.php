...
<div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12"><table class="table w-full table-hover table-bordered table-striped">
    <thead class="text-center sticky-head">
        <tr>
            <th style="width:4%;">SL</th>
            <th style="width: 8%;">Application Date</th>
            <th style="width: 8%;">Retirement Code</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">{{ $emp['retirement_date'] }}</td>
            <td class="text-center">{{ $emp['retirement_code'] }}</td>

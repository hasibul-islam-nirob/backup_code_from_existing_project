...
@section('content')
    ...
    @php
        ...
        $elementArray['startDate'] = ['label' => 'From Date', 'type'=>'startDate', 'id' => 'startDate', 'name'=> 'start_date', 'required' => false];
        $elementArray['endDate'] = ['label' => 'To Date', 'type'=>'endDate', 'id' => 'endDate', 'name'=> 'end_date', 'required' => false];

        $elementArray['select_box2'] = [
            'label'=>"Transfer Code",
            'type'=>'text',
            'id'=> 'se_transfer_code',
            'name' => 'se_transfer_code',
        ];
        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Transfer Report',
                    'title_excel' => 'Employee_Transfer_Report',
    ...
    <script>
        ...
        $(document).ready(function(event){
            ...
            $('#filterFormId').submit(function (event) {
                ...
                if(flag){
                    $('.show').show('slow');
                    $("#reportingDiv").load('{{URL::to("hr/reports/emp_transfer/loadData")}}'+'?'+$("#filterFormId").serialize());
                }
            });

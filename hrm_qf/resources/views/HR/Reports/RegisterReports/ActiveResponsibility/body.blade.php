    ...
    <table class="table w-full table-hover table-bordered table-striped">
        <thead class="text-center sticky-head">
            <tr>
                ...
                <th style="width: 11%;">Application Date</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $emp['active_responsibility_date'] }}</td>
                <td class="text-center">{{ $emp['active_responsibility_code'] }}</td>
                ...
                <td>{{ $emp['designation_to_promote'] }}</td>

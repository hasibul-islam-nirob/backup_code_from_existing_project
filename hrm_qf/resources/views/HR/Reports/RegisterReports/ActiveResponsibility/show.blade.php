        ...
        <div class="panel">
            <div class="panel-body panel-search pt-2">
                ...
                @include('elements.report.reporting_header', [
                    'reportTitle' => 'Employee Active Responsibility Report',
                    'title_excel' => 'Employee_Active_Responsibility_Report',
    ...
    $(document).ready(function(event){
        $('#searchButton').click(function(){
            ...
            $('#filterFormId').submit(function (event) {
                ...
                if(flag){
                    $('.show').show('slow');
                    $("#reportingDiv").load('{{URL::to("hr/reports/act_respons/loadData")}}'+'?'+$("#filterFormId").serialize());
                }
            });
        })
    });

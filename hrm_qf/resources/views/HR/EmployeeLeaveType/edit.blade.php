        ...
        <div class="row">
            <div class="col-sm-12 offset-sm-3">
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input value="{{ $data['edited_data']->leave_name }}" id="leave_name" name="leave_name" type="text" class="form-control round" style="width: 100%">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input value="{{ $data['edited_data']->short_name }}" id="short_name" name="short_name" type="text" class="form-control round" style="width: 100%">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <div class="radio-custom radio-primary">
                                <input {{ ($data['edited_data']->leave_type == 'Pay') ? 'checked' : '' }} type="radio" name="leave_type" value="Pay">
                                <label for="g1">Pay &nbsp &nbsp </label>
                            </div>
                            <div class="radio-custom radio-primary">
                                <input {{ ($data['edited_data']->leave_type == 'Non Pay') ? 'checked' : '' }} type="radio" name="leave_type" value="Non Pay">

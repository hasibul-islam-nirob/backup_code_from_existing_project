    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-2">
            ...
            <div class="row form-group">
                <label class="input-title col-sm-7 offset-sm-1" style=""> 
                    Late Present Breakdown
                </label>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="LpBreakdownTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <span id="lpbTitle">From 0 to</span>  <input id="dayInput1" type="text" value="" style="border:0px; float: right; width: 5rem; margin-right: 1rem;">
                                    </td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="ActionForLpTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="lpNumInput1" type="text" value="" style="border:0px; float: right; width: 5rem; margin-right: 1rem;">
                                </td>
                                <td class="" style="text-align: center;">
    ...
    $(".createLpRowIcon").on('click', function(event){
        ...
        if (trCount > 1) {
            ...
            if (1) {
                ...
                $("#setJsonStringLPB").html(lpbJsonData)
                // console.log(lpbJsonData);
            }
    ...
    $(".AddActionForLpBtn").on('click', function(event) {
        ...
        $("#ActionForLpTable").append(
            ...
            if (1) {
                ...
                $("#setJsonActionForLpString").html(aflpJsonData)
                // console.log(aflpJsonData);
            }

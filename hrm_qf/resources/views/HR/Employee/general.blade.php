        ...
        <div class="row">
            <div class="col-sm-6" >
                {!! HTML::forBranchFeildTTL([
                    'selectBoxShow'=> true,
                    'isRequired'=> true,
                    'elementName' => 'branch_id_edit',
                    'elementId' => 'branch_id_edit',
                    'divClass'=> "col-sm-12 input-group",
                    'formStyle'=> "horizontal",
                    'isDisabled' => true
                ]) !!}
                <input type="text" name="branch_id" id="branch_id" value="" style="display: none;">
            </div>
                ...
                <div class="presentAddressDiv">
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                <select name="emp_pre_addr_division_id" class="form-control clsSelect2 division" id="pre_division">
                                    <option value="">Select</option>
                                ...
                                {{-- <input type="text" name="emp_pre_addr_division_id"  class="form-control" id="division" > --}}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                <select name="emp_pre_addr_district_id" class="form-control clsSelect2 district" id="pre_district">
                                    <option value="">Select</option>
                                ...
                                {{-- <input type="text" name="emp_pre_addr_district_id"  class="form-control" id="district" > --}}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_pre_addr_thana_id"  class="form-control" id="pre_upazila" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_pre_addr_union_id"  class="form-control" id="pre_union" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            <label class="input-title">Village/Area/Moholla</label>
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_pre_addr_village_id"  class="form-control" id="pre_village" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_par_addr_thana_id"  class="form-control" id="par_upazila" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_par_addr_union_id"  class="form-control" id="par_union" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="emp_par_addr_village_id"  class="form-control" id="par_village" >
...
<script>
    ...
    // console.log(empPerData);
    // console.log(empSysData);
    // console.log(empData);
    ...
    $(document).ready(function (){
        if (empPerData !== null && empData !== null){
            ...
            console.log(document.querySelector('[name=branch_id]'));
            console.log(empSysData[0]['branch_id']);

            setEditData(document.querySelector('[name=branch_id]'), empSysData[0]['branch_id']);
            setEditData(document.querySelector('[name=branch_id_edit]'), empSysData[0]['branch_id']);
            ...
            setEditData(document.querySelector('[name=emp_pre_addr_division_id]'), empPerData[0]['pre_addr_division_id']);
            setEditData(document.querySelector('[name=emp_pre_addr_district_id]'), empPerData[0]['pre_addr_district_id']);
            setEditData(document.querySelector('[name=emp_pre_addr_thana_id]'), empPerData[0]['pre_addr_thana_name']);
            setEditData(document.querySelector('[name=emp_pre_addr_union_id]'), empPerData[0]['pre_addr_union_name']);
            setEditData(document.querySelector('[name=emp_pre_addr_village_id]'), empPerData[0]['pre_addr_village_name']);
            setEditData(document.querySelector('[name=emp_pre_addr_street]'), empPerData[0]['pre_addr_street']);
            setEditData(document.querySelector('[name=emp_par_addr_division_id]'), empPerData[0]['par_addr_division_id']);
            setEditData(document.querySelector('[name=emp_par_addr_district_id]'), empPerData[0]['par_addr_district_id']);
            setEditData(document.querySelector('[name=emp_par_addr_thana_id]'), empPerData[0]['par_addr_thana_name']);
            setEditData(document.querySelector('[name=emp_par_addr_union_id]'), empPerData[0]['par_addr_union_name']);
            setEditData(document.querySelector('[name=emp_par_addr_village_id]'), empPerData[0]['par_addr_village_name']);
            setEditData(document.querySelector('[name=emp_par_addr_street]'), empPerData[0]['par_addr_street']);
    ...
    $('.division,.district').on("select2:select", function(e) {
        e.preventDefault();
        var source = $(this);
        var url = '';
        ...
        $.ajax({
            ...
            success: function(options) {
                ...
                $.each(options, function(index, value) {
                    target.append("<option value=" + index + ">" + value + "</option>");
                });
            },
            error: function() {
                // console.log('error!');
    ...
    $('#sameAsPreesent').change(function(e) {
        ...
        if ($(this).is(":checked")) {
            ...
            let thana = $("#pre_upazila").val();
            let union = $("#pre_union").val();
            let village = $("#pre_village").val();
            $("#par_upazila").val(thana);
            $("#par_union").val(union);
            $("#par_village").val(village);
    ...
    function setEditData(node, value, imageTarget = null){
        // console.log(node.tagName + ' = ' + value);
        if (node === null){
            //console.log("nullll");
        }
    ...
    /*
    function autoCompleteDivisionFunction(){
        ...
        let actionUrl = "";
        if (findAction == 'edit') {
            actionUrl = "{{ url()->current() }}/../../getDivisionData";
        }else if (findAction == 'add'){
            actionUrl = "{{ url()->current() }}/../getDivisionData";
        }

        let divData = $("#division").val();

        $.ajax({
            type: "POST",
            url: actionUrl,
            data: {context : 'getDivisionData'},
            dataType: "json",
            success: function (response) {
                ...
                $.each(response, function( index, item ) {
                    if (item.id == empPerData[0].par_addr_division_id) {
                        $("#division").val(item.division_name);
                    }
                    DivisionArray.push(item.division_name);
                });
    ...
    autoCompleteDivisionFunction();

    function autoCompleteDistrictFunction(){
        let districtArray = [];
        ...
        let actionUrl = "";
        if (findAction == 'edit') {
            actionUrl = "{{ url()->current() }}/../../getDistrictData";
        }else if (findAction == 'add'){
            actionUrl = "{{ url()->current() }}/../getDistrictData";
        }
        ...
        $.ajax({
            type: "POST",
            url: actionUrl,
            data: {context : 'getDistrictData', divisionData : divData},
            dataType: "json",
            success: function (response) {
                ...
                $.each(response, function( index, item ) {
                    if (item.id == empPerData[0].par_addr_district_id) {
                        $("#district").val(item.district_name);
                    }
                    districtArray.push(item.district_name);
                });
    ...
    $("#division").change(function(){
        autoCompleteDistrictFunction();
    });
    */

    function autoCompleteUpazilaFunction(event){
        ...
        if (findAction == 'edit' || findAction == 'view' ) {
            actionUrl = "{{ url()->current() }}/../../getUpazilaData";
        }else{
            actionUrl = "{{ url()->current() }}/../getUpazilaData";
        }

        let districtData = $("#pre_district").val();
        let upazilaData = $("#pre_upazila").val();

        $.ajax({
            type: "POST",
            url: actionUrl,
            data: {context : 'getUpazilaData', districtData : districtData, upazilaData : upazilaData},
            dataType: "json",
            success: function (response) {

                $.each(response, function( index, item ) {
                    if(empPerData != null){
                        if (item.id == empPerData[0].par_addr_thana_id) {
                            $("#pre_upazila").val(item.upazila_name);
                        }
                    }
                    upazilaArray.push(item.upazila_name);
                });
        ...
        autocomplete(document.getElementById('pre_upazila'), upazilaArray);
    }
    $("#pre_upazila").click(function(event){
        autoCompleteUpazilaFunction(event);
    });
    // $("#pre_upazila").change(function(event){
    //     autoCompleteUpazilaFunction(event);
    // });

    function autoCompleteUnionFunction(event){
        event.preventDefault();
        let unionArray = [];
        ...
        let actionUrl = "";
        if (findAction == 'edit' || findAction == 'view') {
            actionUrl = "{{ url()->current() }}/../../getUnionData";
        }else{
            actionUrl = "{{ url()->current() }}/../getUnionData";
        }

        let upazilaData = $("#pre_upazila").val();
        let unionData = $("#pre_union").val();

        $.ajax({
            type: "POST",
            url: actionUrl,
            data: {context : 'getUnionData', upazilaData : upazilaData, unionData : unionData},
            dataType: "json",
            success: function (response) {

                $.each(response, function( index, item ) {
                    if (empPerData != null) {
                        if (item.id == empPerData[0].par_addr_union_id) {
                            $("#pre_union").val(item.union_name);
                        }
                    }
                    unionArray.push(item.union_name);
                });
        ...
        autocomplete(document.getElementById('pre_union'), unionArray);

    }
    $("#pre_union").click(function(event){
        autoCompleteUnionFunction(event);
    });
    // $("#pre_union").change(function(event){
    //     autoCompleteUnionFunction(event);
    // });

    function autoCompleteVillageFunction(event){
        event.preventDefault();
        let villageArray = [];
        ...
        let actionUrl = "";
        if (findAction == 'edit' || findAction == 'view') {
            actionUrl = "{{ url()->current() }}/../../getVillageData";
        }else{
            actionUrl = "{{ url()->current() }}/../getVillageData";
        }

        let unionData = $("#pre_union").val();
        let villageData = $("#pre_village").val();

        $.ajax({
            type: "POST",
            url: actionUrl,
            data: {context : 'getVillageData', unionData : unionData, villageData : villageData},
            dataType: "json",
            success: function (response) {

                $.each(response, function( index, item ) {
                    if (empPerData != null) {
                        if (item.id == empPerData[0].pre_addr_village_id) {
                            $("#pre_village").val(item.village_name);
                        }
                    }
                    villageArray.push(item.village_name);
                });
        ...
        autocomplete(document.getElementById('pre_village'), villageArray);

    }
    $("#pre_village").click(function(event){
        autoCompleteVillageFunction(event);
    });
    $("#pre_village").change(function(event){
        autoCompleteVillageFunction(event);
    });
</script>

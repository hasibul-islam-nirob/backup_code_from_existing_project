            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="af_grade" id="edit_af_grade" style="width: 100%" disabled>
                                <option value="">Select</option>
                                @for($i = 1; $i<= 7; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="af_level" id="edit_af_level" style="width: 100%" disabled>
                                <option value="">Select</option>
                                @for($i = 1; $i<= 4; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="af_org_payscale_year_id" id="edit_af_payscale_year_id" style="width: 100%" disabled>
                                <option value="">Select </option>
                                @foreach($payscaleData as $row)
                                    <option value="{{ $row->id }}">{{ $row->name }}</option>
                                @endforeach
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="af_org_step" id="edit_af_step" style="width: 100%" disabled>
                                <option value="">Select Step</option>
                                @for($i = 1; $i<=12; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
...
<script>
    ...
    showModal({
        titleContent: "View Payroll Pay Scale Migration",

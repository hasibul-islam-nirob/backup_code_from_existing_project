...
<form id="payroll_config_add_menu_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-1 form-group">
                    ...
                    <div class="input-group">
                        <select multiple name="permanent[]" id="add_permanent" class="form-control clsSelect2" style="width: 100%">
                ...
                <div class="col-sm-5  form-group">
                    ...
                    <div class="input-group">
                        <select multiple name="nonpermanent[]" id="add_nonpermanent" class="form-control clsSelect2" style="width: 100%">
                            <option value=""  disabled>Select </option>
                            @foreach ($permanentNonPermanentData as $val)
                            <option value="{{ $val->value_field }}">{{ $val->name }}</option>
                            @endforeach
...
<script>
    ...
    // getPayrollSettingStatus('add_permanent', '{{ url()->current() }}');
    // getPayrollSettingStatus('add_nonpermanent', '{{ url()->current() }}');
    ...
    $('#add_saveBtn').click(function(event) {
        ...
        callApi("{{ url()->current() }}/../insert/api", 'post', new FormData($('#payroll_config_add_menu_form')[
                0]),

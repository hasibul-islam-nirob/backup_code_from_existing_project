...
<form id="payroll_donation_sector_add_form" enctype="multipart/form-data" method="post" data-toggle="validator" novalidate="true">
    @csrf
...
<script>
    ...
    showModal({
        titleContent: "Add Payroll Donation Sector",
    ...
    $('#add_saveBtn').click(function(event) {
        ...
        callApi("{{ url()->current() }}/../insert/api", 'post', new FormData($('#payroll_donation_sector_add_form')[
                0]),

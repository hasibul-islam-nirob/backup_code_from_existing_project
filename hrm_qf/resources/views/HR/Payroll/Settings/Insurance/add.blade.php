        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-1 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" value="" name="first_maturity_y">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" value="" name="first_maturity_interest_rate">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 offset-sm-1 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" value="" name="second_maturity_y">
                    </div>
                </div>
                ...
                <div class="col-sm-5 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" value="" name="second_maturity_interest_rate">
                    </div>
                </div>

...
<div class="row">
    <div class="col-lg-12">
        <h4 id="details_grid_header" class="" style="background-color: rgba(23,179,163); color:#fff; padding:10px 0 10px 10px;">OSF Settings</h4>
    </div>
</div>
...
@php
    $detailsData = isset($viewData->pension_scheme_details)? $viewData->pension_scheme_details : [];
@endphp
...
<script>
    ...
    showModal({
        titleContent: "View OSF Settings",
    });
</script>
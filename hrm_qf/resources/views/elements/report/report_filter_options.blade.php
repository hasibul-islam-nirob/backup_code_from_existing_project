            ...
            <div class="row align-items-center pb-10">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="voucher_type" id="voucher_type">
                                ...
                                <option value="1" selected>Cash-Bank</option>
                ...
                @if (isset($product) && $product)
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="prodcutorcode" id="prodcutorcode" placeholder="Enter {{isset($product[0]['title'])? $product[0]['title'] : "Name Or Code"}}" >
                        </div>
                    </div>
                @endif
                ...
                @endif --}}
                @if ((isset($salesByOnlyPosReport) && $salesByOnlyPosReport))
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="salesBy_id" id="salesBy_id">
                                <option value="">All</option>
                                ...
                                @endphp
                                    @foreach ($employeeData as $row)
                                        <option value="{{ ($loadByEmpNo)?  $row->employee_no : $row->id }}">
                ...
                @if(isset($productType) && $productType)
                    <div class="col-lg-2">
                        @php
                        $product_type = DB::table("gnl_dynamic_form_value")
                        ...
                        <label class="input-title">Product Type</label>
                        <div class="input-group">
                            <select class="form-control clsSelect2" required data-error="Please select product Type."
                                    name="prod_type_id" id="prod_type_id">
                ...
                <div class="col-lg-2">
                    <label class="input-title">Voucher Generated</label>
                ...
                {{-- @if(isset($reportHideColumn) && count($reportHideColumn)>0)
                    <div class="col-lg-2">
                        <label class="input-title">Report Hide Column</label>
                        <select class="form-control clsSelect2" name="report_hide_column" id="report_hide_column" data-placeholder="Select Columns" onchange="fnHideReportColumns();" multiple>
                            <option value="">Default</option>
                            @foreach ($reportHideColumn as $item)
                                <option value="{{$item['value']}}">{{$item['name']}}</option>
                            @endforeach

<div class="col-sm-2">
    ...
    <div class="input-group">
        <input type="text" class="form-control" id="fromMonthYear" name="fromMonthYear"
...
<script>
    ...
    $("#fromMonthYear").click(function () {
        $(".ui-datepicker-calendar").hide();
    });

    $("#fromMonthYear").focus(function () {
        $(".ui-datepicker-calendar").hide();
    });

    $("#fromMonthYear").on('click', function () {
        this.value = '';
    });
</script>
